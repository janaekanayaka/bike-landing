        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <a href="#welcome" className="hover:text-blue-600">Home</a>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="#welcome" className="block hover:text-blue-600 py-2">Home</a>
            <a href="#about" className="block hover:text-blue-600 py-2">About</a>
            <a href="#products" className="block hover:text-blue-600 py-2">Products</a>
            <a href="#testimonials" className="block hover:text-blue-600 py-2">Testimonials</a>
